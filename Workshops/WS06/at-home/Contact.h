...
namespace sict {
	...
	public:
		...
		Contact(const Contact &orgContact);
		...
		void display() const;
		void setToEmpty();
		void copyContact(const Contact & Source_Contact);

		Contact& operator= (const Contact& Source_Contact);
		void operator+=(long long Phone_Num);
