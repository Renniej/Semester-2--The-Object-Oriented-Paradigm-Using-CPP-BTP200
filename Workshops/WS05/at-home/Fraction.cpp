...
namespace sict {
	...
	Fraction Fraction::operator*(const Fraction& rhs) const {
		...
		New.m_numer = (m_numer * rhs.m_numer);
		New.m_denom = (m_denom * rhs.m_numer);
	...
	bool Fraction::operator==(const Fraction& rhs) const {
		...
		bool IsEqual = false; //assume false till proven true
	...
	bool Fraction::operator!=(const Fraction& rhs) const {
		...
		bool NotEqual = false; //assume false till proven true
	...
	Fraction& Fraction::operator+=(const Fraction& rhs)  {  //Research behaviour of pointers verse reference verse value....
		
			Fraction temp = *this + rhs;

			m_numer = temp.m_numer;
			m_denom = temp.m_denom;
